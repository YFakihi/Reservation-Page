...
class TeamsController 
{
    ...
    public function edit($id)
    {
        ...
        public function add()
        {
            include "../app/View/dashboard/teams/addteams.php";
        }
        ...
        $data = [];
        $data['id'] = $_POST['id'];
        $data['NomEquipe'] = $_POST['NomEquipe'];
        $data['Entraineur'] = $_POST['Entraineur'];
        $data['NombreJoueurs'] = $_POST['NombreJoueurs'];


        $teamModel->addTeam($data);
        $redirect = URL_DIR . 'EquipesNationales';
